...
#include "org_rocksdb_FlinkCompactionFilter.h"
#include <include/rocksdb/env.h>
#include "flink_compaction_filter.h"
...
JNIEnv* JniCallback::getJniEnv(jboolean* attached) const {
    return rocksdb::JniUtil::getJniEnv(m_jvm, attached);
}

void JniCallback::releaseJniEnv(jboolean& attached) const {
    rocksdb::JniUtil::releaseJniEnv(m_jvm, attached);
}
...
class JniCallbackBase : public JniCallback {
public:
